# What Every CS Engineer should know!
...
- ### Linked Lists
    ...
    - [X] [why you should avoid linked lists THIS BLEW MY FUCKING MIND. (video)](https://www.youtube.com/watch?v=YQs6IC-vgmo)
...
- ### Binary search trees: BSTs
    ...
    - [ ] Implement:
        ...
        - [X] delete_tree
        - [X] search // returns true if given value exists in the tree
...
- [X] Shai Simonson, [Aduni.org](http://www.aduni.org/): (JUST WOW)
